...
$string['cronruntimescheduledtasksmanagement'] = 'From Moodle 2.7 on, Moodle core supports a system called "Scheduled tasks". The execution time settings of the sandbox plugin, which have been configured on this page until Moodle 2.6, can be now configured in the "Scheduled tasks" system.';
$string['cronruntimescheduledtasksactivate'] = 'By default, sandbox\'s scheduled task is disable in the "Scheduled tasks" system. You have to enable it there to make use of this plugin.';
