...
$string['adjustcoursestartdatedescription'] = 'Set course start date to today instead of setting it to the date saved in the course backup file';
$string['coursebackupsdescription'] = 'Specify the path to the directory where the course backup files to use for course restoring are. Course backup files in this directory must be named with the appropriate course short name and must have the .mbz filename extension.';
...
$string['cronrundaydescription'] = 'Restore sandbox courses on these days';
$string['cronruntime'] = 'Execution time';
$string['cronruntimedescription'] = 'Restore sandbox courses on this time of day';
...
$string['notifyleveldescription'] = 'Email notifications will only be sent for events you wish to be notified of. What do you want to be notified of?';
$string['notifyonerrors'] = 'Email failures to';
$string['notifyonerrorsdescription'] = 'If sandbox failures occur, email notifications can be sent out. Who should see these notifications?';
